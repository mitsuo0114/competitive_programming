...
INF = 2 ** sys.int_info.bits_per_digit - 1
...
assert (solve(3, 3, 3, [1, 2, 3], [(1, 2, 1), (2, 3, 1), (3, 1, 4)]) == 2)
assert (solve(3, 3, 2, [1, 3], [(2, 3, 2), (1, 3, 6), (1, 2, 2)]) == 4)
assert (solve(4, 6, 3, [2, 3, 4], [(1, 2, 4), (2, 3, 3), (4, 3, 1), (1, 4, 1), (4, 2, 2), (3, 1, 6)]) == 3)
